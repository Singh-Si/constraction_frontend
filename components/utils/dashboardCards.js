...
const DashboardCard = (props) => {
  ...
  return (
    <div className="card border rounded-12 overflow-hidden">
      ...
      <div className="card-body">
        <div className="row">
          <div className="col-8">
            ...
            <div className="card-text my-2">
              Start Date:{" "}
              <span className="_gray_light">{formatDate(props?.startdate)}</span>
            </div>

            <div className="card-text">
              End Date: <span className="_gray_light">{formatDate(props?.enddate)}</span>
            </div>
          </div>
          ...
          {props.update && (
            <div className="col-4 cursor-pointer d-flex flex-column justify-content-center align-items-end">
              ...
              <ul className="dropdown-menu" style={{ width: "180px", border: "1px solid black" }}>
                <li>
                  <Link
                    href="/sites/site-setting"
                    className="dropdown-item link_hover"
      ...
      <style jsx>{`
        .image-container {
          max-height: 10rem; /* Adjust the max height as needed */
          overflow: hidden;
          display: flex;
